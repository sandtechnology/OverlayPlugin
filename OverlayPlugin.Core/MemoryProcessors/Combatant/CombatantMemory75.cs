...
{
    interface ICombatantMemory75 : ICombatantMemory { }

    class CombatantMemory75 : CombatantMemory, ICombatantMemory75
    {
        ...
        // Remove the struct for `EffectMemory75`, and adjust the parent struct to have the correct size of 16 bytes.
        public CombatantMemory75(TinyIoCContainer container)
            : base(container, charmapSignature, CombatantMemory.Size, EffectMemory75.Size, 629)
        {
        ...
        protected override unsafe Combatant GetCombatantFromByteArray(byte[] source, uint mycharID, bool isPlayer, bool exceptEffects = false)
        {
            fixed (byte* p = source)
            {
                ...
                Combatant combatant = new Combatant()
                {
                    ...
                    IsCasting1 = (byte)(mem.CastFlags & 0x1),
                    IsCasting2 = mem.CastActionType,
        ...
        private unsafe struct CombatantMemory
        {
            ...
            public const int EffectBytes = EffectMemory75.Size * EffectCount;
        ...
        protected new unsafe List<EffectEntry> GetEffectEntries(byte* source, ObjectType type, uint mycharID)
        {
            ...
            var size = EffectMemory75.Size * maxEffects;
        ...
        protected new unsafe EffectEntry GetEffectEntryFromByteArray(byte[] source, int num = 0)
        {
            fixed (byte* p = source)
            {
                EffectMemory75 mem = *(EffectMemory75*)&p[num * EffectMemory75.Size];
