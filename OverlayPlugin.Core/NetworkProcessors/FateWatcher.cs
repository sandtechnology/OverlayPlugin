...
namespace RainbowMage.OverlayPlugin.NetworkProcessors
{
    ...
    {
        private TinyIoCContainer container_;
        ...
        public void RemoveAndClearCEs()
        {
            ...
            {
                OnCEChanged(null, new CEChangedArgs("remove", ces[ceKey]));
            }
            ces.Clear();
        }
        ...
        public class CEChangedArgs : EventArgs
        {
            public string eventType { get; private set; }
            public CEDirectorData data { get; private set; }
            public int progress { get; private set; }
